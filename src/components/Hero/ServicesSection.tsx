  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden py-16">
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
        ...
        >
          From prototyping to production, we provide cutting-edge manufacturing solutions
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {services.map((service, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300"
            >
        ...
        >
          ...
          <p className="text-slate-300 mb-6">Get a free consultation and quote for your project today</p>
